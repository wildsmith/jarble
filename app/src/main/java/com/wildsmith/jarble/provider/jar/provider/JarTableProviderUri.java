...
public class JarTableProviderUri {
    ...
    private static final String PROVIDER_NAME = "com.wildsmith.jarble";
    ...
    public enum UriCode {
        ...
        JARS_FOR_YEAR(PROVIDER_NAME, "/jar/year/", 2),
        JARS_FOR_MONTH(PROVIDER_NAME, "/jar/year/month", 3),
        JARS_FOR_WEEK(PROVIDER_NAME, "/jar/year/month/week", 4),
        JARS_FOR_DAY(PROVIDER_NAME, "/jar/year/month/week/day", 5);
