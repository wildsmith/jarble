...
public class MarbleTableProviderUri {

    private static final String PROVIDER_NAME = "com.wildsmith.jarble.marble";
    ...
    public enum UriCode {
        ...
        MARBLE(PROVIDER_NAME, "/marble/", 1),
        MARBLES(PROVIDER_NAME, "/marble/*", 2);
