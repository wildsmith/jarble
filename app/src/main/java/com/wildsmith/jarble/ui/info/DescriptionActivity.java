...
public class DescriptionActivity extends BaseActivity {
    ...
    private void createInfoFragment(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            bundle.putString(InfoFragment.Extras.INFO.name(), getString(R.string.description_info));
    ...
    private void setupBackdrop() {
        ...
        new BitmapLoader.Builder().setResources(getResources()).setResourceId(R.drawable.give_a_hoot).setImageView(backdrop)
            .loadBitmap();
    }
    ...
    private void setupCollapsingToolbarLayout() {
        ...
        if (collapsingToolbar != null) {
            collapsingToolbar.setTitle(getString(R.string.description_title));
        }
    }
